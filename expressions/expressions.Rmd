...
I’m going to use `expression()` with `labs()`, but the same expressions can be used with any of function that writes text on a plot (including plots made with base graphics).
