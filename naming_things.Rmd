...
The object can not be used in futher calculations.
...
question_checkbox(
  ...
  answer("If the result of a function is not assigned to an name, it is printed to the screen and lost.", correct = TRUE),
  answer("Forgetting to assign an object is one of the commonest errors.", correct = TRUE),
